...
1. **Stateless**
    - FaaS 서비스는 함수가 실행되는 동안에만 관련된 자원을 할당하게 된다. 또한 함수가 항상 같은 머신에서 실행된다는 보장이 없다.
    - 따라서, 함수 실행 시 로컬에서의 어떤 상태(State)가 유지될 수 없다.
...
![출처: https://www.slideshare.net/AmazonWebServices/become-a-serverless-black-belt-optimizing-your-serverless-applications-aws-online-tech-talks/14](/images/20210218-1.png)  
...
2020년 Middleware에서 발표된 Paulo Silva의 논문[^1]에서는 CRIU 툴을 이용해 함수가 실행되는 프로세스의 스냅샷을 백업/복원하여 속도를 향상시키는 방법을 제안했다.
...
![출처: https://levelup.gitconnected.com/lambda-cold-starts-language-comparison-️-a4f4b5f16a62](/images/20210218-2.png)  
...
![출처: https://doi.org/10.1145/3423211.3425682](/images/20210218-3.png)  
...
[^1]: Paulo Silva, Daniel Fireman, and Thiago Emmanuel Pereira, 2020. Prebaking Functions to Warm the Serverless Cold Start. In Middleware ‘20, December 7-11, 2020, Delft, Netherlands. https://doi.org/10.1145/3423211.3425682